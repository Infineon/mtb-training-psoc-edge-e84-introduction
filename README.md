...
The training is an introduction to PSOC™ Edge. 
...
## Agenda
<!-- Training agenda -->
1. Introduction to PSOC™ Edge
2. Overview of PSOC™ Edge Features
3. Application use-cases
4. Getting started with PSOC™ Edge
...
|------------|-----------|-----------------------------------|
| [11/25/2025] | [1.0] | [Release version]             |